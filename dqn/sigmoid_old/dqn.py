    ...
    def _build_net(self):
        ...
        with tf.variable_scope('eval_net'):
            ...
            with tf.variable_scope('layer1'):
                l1 = self.add_layer(inputs=self.s, in_size=self.n_features, out_size=6, activation_function=tf.nn.sigmoid,
                                    norm=True, )

            # layer 2
            with tf.variable_scope('layer2'):
                l2 = self.add_layer(inputs=l1, in_size=6, out_size=6, activation_function=tf.nn.sigmoid, norm=True, )

            with tf.variable_scope('layer3'):
                l3 = self.add_layer(inputs=l2, in_size=6, out_size=6, activation_function=tf.nn.sigmoid, norm=True, )

            # output layer
            with tf.variable_scope('output_layer'):
                self.q_eval = self.add_layer(inputs=l3, in_size=6, out_size=self.n_actions,
        ...
        with tf.variable_scope('target_net'):
            ...
            # output layer
            with tf.variable_scope('output_layer'):
                self.q_next = self.add_layer(inputs=l3, in_size=6, out_size=self.n_actions,
                                             activation_function=tf.nn.sigmoid,
                                             norm=False, )
