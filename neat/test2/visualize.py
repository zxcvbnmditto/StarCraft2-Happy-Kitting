...
def draw_net(config, genome, path, view=False, filename=None, node_names=None, show_disabled=True, prune_unused=False,
    ...
    dot.render(filename='network', view=view, directory=path, cleanup=True)
